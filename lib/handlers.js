...
module.exports = handlers = {
    'LaunchRequest': function() {
        self = this;
        const welcomeSpeech = 'Hello!; How can i help you today? You can ask current Forecast, local Temperature, or say help to know a list of commands';
            ...
            if (error) {
                ...
                navigator.weatherUtil.getWeatherObject(addressPayload, function(error, speech) {
                    if (error) {
                        ...
                        const speechOutput = speech + '. would you want to know anything else ? try saying Forecast';
    ...
    'AMAZON.HelpIntent': function() {
        self = this;
        const speechOutput = "HELP. Try saying things like, Tell me today's forecast. Or,  What is the temperature. Or, Tell me a motivational quote" +
